-- Create additional Service Management Module Database Schema (complementing existing tables)
...
-- Service Categories lookup table (admin-definable) - if not exists
